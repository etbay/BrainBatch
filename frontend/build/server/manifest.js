...
return {
	...
	_: {
		...
		nodes: [
			__memo(() => import('./chunks/0-CMkq9YHC.js')),
			__memo(() => import('./chunks/1-CmfBSC0o.js')),
			__memo(() => import('./chunks/4-BAVmaNIz.js')),
			__memo(() => import('./chunks/5-DDmsPdu7.js')),
			__memo(() => import('./chunks/6-B1LVv1kB.js')),
			__memo(() => import('./chunks/7-B9G8mJq3.js')),
			__memo(() => import('./chunks/8-Cv4KFahZ.js'))
		],
		remotes: {
